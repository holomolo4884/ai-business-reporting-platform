...
- [ ] B-01. Установить Django 5.x
- [ ] B-02. Создать Django-проект: `django-admin startproject config .`
...
- [ ] E-05. Автоматически назначать создателя организации владельцем
- [ ] E-06. Ограничить доступ: пользователь видит только свои организации
- [ ] E-07. Сделать API участников организации
- [ ] E-08. Проверить права доступа к организациям и участникам
...
- [ ] G-01. Установить faker и factory-boy
...
- [ ] G-06. Сгенерировать demo расходы
- [ ] G-07. Распределить данные за последние 30/60/90 дней
- [ ] G-08. Проверить работу seed-команды
...
- [ ] I-01. Сделать генерацию отчёта: `POST /api/v1/reports/generate/`
- [ ] I-02. Добавить валидацию периода
- [ ] I-03. Проверять права доступа к организации
- [ ] I-04. Возвращать статус созданного отчёта
- [ ] I-05. Сделать список отчётов: `GET /api/v1/reports/`
- [ ] I-06. Сделать детали отчёта: `GET /api/v1/reports/{id}/`
- [ ] I-07. Сделать повторную генерацию: `POST /api/v1/reports/{id}/regenerate/`
- [ ] I-08. Сделать скачивание отчёта: `GET /api/v1/reports/{id}/download/`
- [ ] I-09. Добавить пагинацию для списка отчётов
- [ ] I-10. Добавить фильтрацию отчётов
